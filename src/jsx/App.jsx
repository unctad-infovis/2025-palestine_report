...
function App() {
  const file_path = `${(window.location.href.includes('unctad.org')) ? 'https://storage.unctad.org/2025-palestine_report/' : (window.location.href.includes('localhost:80')) ? './' : 'https://unctad-infovis.github.io/2025-palestine_report/'}assets`;
    ...
    <div className="app">
      ...
      <div className="images_container">
        ...
        <div className="image_container">
          ...
          <img src={`${file_path}/img/2025-05.png`} alt="Luminosity in Gaza in May 2025" />
        </div>
      </div>
